...
pub const COL_NAME_SIZE_DEFAULT: usize = 25;
pub const COL_NAME_SIZE_MIN: usize = 15;
pub const COL_PATH_SIZE_DEFAULT: usize = 35;
pub const COL_PATH_SIZE_MIN: usize = 25;
